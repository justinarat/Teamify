...
def upgrade():
    ...
    with op.batch_alter_table('LobbyPlayers', schema=None) as batch_op:
        ...
        batch_op.alter_column('RowID',
               ...
               nullable=False)
        batch_op.drop_constraint('fk_lobby_players_lobby_old', type_='foreignkey')  # Use the actual name
    ...
    with op.batch_alter_table('LobbyTags', schema=None) as batch_op:
        ...
        batch_op.alter_column('RowID',
               existing_type=sa.String(),
               nullable=False)
        batch_op.drop_constraint('fk_lobby_tags_lobby_old', type_='foreignkey')  # Use the actual name
    ...
    with op.batch_alter_table('LobbyTimes', schema=None) as batch_op:
        batch_op.add_column(sa.Column('LobbyId', sa.Text(), nullable=False))
        batch_op.create_unique_constraint('uq_lobby_times_repeat', ['Repeat'])  # Use the actual name
        batch_op.drop_constraint('fk_lobby_times_lobby_old', type_='foreignkey')  # Use the actual name
...
def downgrade():
    ...
    with op.batch_alter_table('LobbyTimes', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_lobby_times_lobby_old', 'Lobby', ['LobbyID'], ['LobbyId'])  # Use the actual name
    ...
    with op.batch_alter_table('LobbyTags', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_lobby_tags_lobby_old', 'Lobby', ['LobbyID'], ['LobbyId'])  # Use the actual name
        batch_op.alter_column('RowID',
               existing_type=sa.String(),
               nullable=True)
        batch_op.drop_column('LobbyId')
    ...
    with op.batch_alter_table('LobbyPlayers', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_lobby_players_lobby_old', 'Lobby', ['LobbyID'], ['LobbyId'])  # Use the actual name
        batch_op.alter_column('RowID',
               existing_type=sa.String(),
               nullable=True)
        batch_op.drop_column('LobbyId')
